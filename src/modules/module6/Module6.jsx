  ...
  return (
    ...
    >
      ...
      <p className={styles.completeSub}>
        Congratulations, {userName}. You've completed all six modules of the Bright Beginnings Director Training Program. You are ready to lead.
      </p>
      ...
      <div className={styles.certCard}>
        ...
        <div className={styles.certText}>
          ...
          <p className={styles.certSub}>
            {userName} has completed the full Bright Beginnings Director Operations Training Program — covering foundation and culture, daily operations, people management, business operations, compliance and safety, and communication and community.
          </p>
    ...
    <div>
      <div className={styles.moduleHeader}>
        <div className={styles.moduleHeaderTop}>
          <div>
            <p className={styles.moduleLabel}>Module 6 — Final</p>
