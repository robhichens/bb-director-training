...
function ModuleComplete({ userName }) {
  ...
  return (
    ...
    >
      ...
      <h2 className={styles.completeTitle}>Module 3 Complete!</h2>
      <p className={styles.completeSub}>
        Well done, {userName}. You now have the tools to hire, develop, and lead a high-performing team.
      </p>
      ...
      <div className={styles.nextModuleCard}>
        <div className={styles.nextModuleText}>
          ...
          <p className={styles.nextModuleTitle}>Module 4: Business Operations</p>
          <p className={styles.nextModuleSub}>
            Billing, collections, enrollment KPIs, ProCare mastery, and the monthly Director Packet.
          </p>
        </div>
        <button
        ...
        >
          Start Module 4 <IconArrowRight size={16} style={{verticalAlign:'middle', marginLeft:4}} />
        </button>
      </div>
    </motion.div>
  )
    ...
    <div>
      <div className={styles.moduleHeader}>
        <div className={styles.moduleHeaderTop}>
          <div>
            <p className={styles.moduleLabel}>Module 3</p>
