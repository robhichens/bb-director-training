...
function ModuleComplete({ userName }) {
  ...
  return (
    ...
    >
      ...
      <h2 className={styles.completeTitle}>Module 1 Complete!</h2>
      <p className={styles.completeSub}>
        Outstanding work, {userName}. You've mastered the foundation of Bright Beginnings leadership.
      </p>
      <div className={styles.completeStats}>
        ...
        <div className={styles.stat}>
          ...
          <span className={styles.statLabel}>Activities Done</span>
        </div>
      </div>

      {/* Prominent next-module CTA */}
      <div className={styles.nextModuleCard}>
        <div className={styles.nextModuleText}>
          <p className={styles.nextModuleLabel}>Up Next</p>
          <p className={styles.nextModuleTitle}>Module 2: Daily Operations</p>
          <p className={styles.nextModuleSub}>
            The full operational timeline from 7:30 AM through close — including tours, classroom rounds, and end-of-day reporting.
          </p>
        </div>
        <button
        ...
        >
          Start Module 2 <IconArrowRight size={16} style={{verticalAlign:'middle', marginLeft:4}} />
        </button>
      </div>
    </motion.div>
  )
...
export default function Module1() {
  ...
  // Determine initial section: first incomplete, or first if all done
  ...
  function goToNext() {
    ...
    if (next) {
      ...
      // All sections done — mark module complete
  ...
  function handleQuizComplete(score, passed) {
    ...
    if (passed) {
      completeSection(MODULE_ID, currentId)
      // Slight delay so user can see the pass banner before moving on
    ...
    <div>
      ...
      <div className={styles.moduleHeader}>
        <div className={styles.moduleHeaderTop}>
          <div>
            <p className={styles.moduleLabel}>Module 1</p>
