...
function ModuleComplete({ userName }) {
  ...
  return (
    ...
    >
      ...
      <h2 className={styles.completeTitle}>Module 2 Complete!</h2>
      <p className={styles.completeSub}>
        Excellent work, {userName}. You've mastered the operational rhythm that makes great directors indispensable.
      </p>
      ...
      <div className={styles.nextModuleCard}>
        <div className={styles.nextModuleText}>
          ...
          <p className={styles.nextModuleTitle}>Module 3: Staff Management</p>
          <p className={styles.nextModuleSub}>
            Hiring, onboarding, scheduling, evaluations, and the hard conversations that define great leadership.
          </p>
        </div>
        <button
    ...
    <div>
      <div className={styles.moduleHeader}>
        <div className={styles.moduleHeaderTop}>
          <div>
            <p className={styles.moduleLabel}>Module 2</p>
