...
function ModuleComplete({ userName }) {
  ...
  return (
    ...
    >
      ...
      <h2 className={styles.completeTitle}>Module 5 Complete!</h2>
      <p className={styles.completeSub}>
        Excellent, {userName}. Your center is inspection-ready, and your team knows exactly what to do when it matters most.
      </p>
      ...
      <div className={styles.nextModuleCard}>
        <div className={styles.nextModuleText}>
          <p className={styles.nextModuleLabel}>Final Module</p>
          <p className={styles.nextModuleTitle}>Module 6: Communication & Community</p>
          <p className={styles.nextModuleSub}>
            Parent relationships, social media, enrollment marketing, community partnerships, and the scripts that make hard conversations easier.
          </p>
        </div>
        <button
        ...
        >
          Start Module 6 <IconArrowRight size={16} style={{verticalAlign:'middle', marginLeft:4}} />
        </button>
      </div>
    </motion.div>
  )
    ...
    <div>
      <div className={styles.moduleHeader}>
        <div className={styles.moduleHeaderTop}>
          <div>
            <p className={styles.moduleLabel}>Module 5</p>
